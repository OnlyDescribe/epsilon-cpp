...
#define FACTORYCONFIGURATION "' '--disable-option-checking' '--prefix=/run/media/oldcb/Rewrite/Project/epsilon-cpp/build/.packages/s/singular/latest/4e0143c97b65425b855ad5fd03038b6a' '--enable-streamio' '--enable-debug' '--with-track-fl' '--with-track-backtrace' '--with-pic' 'CFLAGS=' 'LDFLAGS=' 'CPPFLAGS=' 'CXXFLAGS=' '--enable-omalloc' 'OMALLOC_LIBS=/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/omalloc/libomalloc.la' 'OMALLOC_INCLUDES=-I/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular' '--htmldir=/run/media/oldcb/Rewrite/Project/epsilon-cpp/build/.packages/s/singular/latest/4e0143c97b65425b855ad5fd03038b6a/share/doc/singular' '--with-Singular' 'RESOURCES_LIBS=/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/resources/libsingular_resources.la' 'RESOURCES_INCLUDES=-I/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular ' 'FACTORY_LIBS=/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/factory/libfactory.la' 'FACTORY_INCLUDES=-I/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular -I/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/factory -I/run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/factory/include' '--cache-file=/dev/null' '--srcdir=.'' in /run/media/oldcb/Rewrite/Project/epsilon-cpp/dep/Singular/factory"
#endif

/* VERSION */
#ifndef FACTORYVERSION
#define FACTORYVERSION "4.3.2"
#endif
...
#define PACKAGE_STRING "factory 4.3.2"
#endif
